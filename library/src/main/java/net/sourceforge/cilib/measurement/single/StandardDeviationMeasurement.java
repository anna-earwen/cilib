 ...
 */
public class StandardDeviationMeasurement implements Measurement {
     ...
     */
    public StandardDeviationMeasurement() {
     ...
     */
    @Override
    public StandardDeviationMeasurement getClone() {
        StandardDeviationMeasurement newCM = new StandardDeviationMeasurement();
