...
import net.sourceforge.cilib.type.types.ArchivedBlackboardString;
 ...
 * represented and maintained within the <code>ArchivedBlackboard</code> as defined by the
 * <code>CandidateSolution</code>.
 */
public class CandidateSolutionArchived implements CandidateSolution {
    private static final long serialVersionUID = 4539668687773346284L;
    private final ArchivedBlackboardString<Enum<?>, Type> properties;

    /**
     * Create the Mixin class, providing the reference to the shared {@linkplain ArchivedBlackboard}
     * data structure.
     */
    public CandidateSolutionArchived() {
        this.properties = new ArchivedBlackboardString<Enum<?>, Type>();
    }
     ...
     */
    public CandidateSolutionArchived(CandidateSolutionArchived copy) {
        this.properties = new ArchivedBlackboardString<Enum<?>, Type>();
     ...
     * @return A shallow clone of the current object - The {@linkplain ArchivedBlackboard} is not cloned.
     */
    @Override
    public CandidateSolutionArchived getClone() {
        return new CandidateSolutionArchived(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        CandidateSolutionArchived other = (CandidateSolutionArchived) obj;
     ...
     */
    @Override
    public ArchivedBlackboardString<Enum<?>, Type> getProperties() {
        return properties;
    }
